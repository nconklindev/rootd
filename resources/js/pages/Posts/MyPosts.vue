...
<template>
    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <div v-else class="rounded border bg-card p-8 text-center text-muted-foreground">I haven't created any posts yet.</div>
        ...
        <div v-if="posts?.total > 1 && posts?.last_page > 1" class="mt-8 flex">
            <Pagination
                ...
                :total="posts?.total"
                class="justify-end"
                @update:page="(p) => router.get(route('posts.me'), { page: p }, { preserveScroll: true, preserveState: true })"
            >
